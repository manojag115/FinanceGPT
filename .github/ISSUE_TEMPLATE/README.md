...
Thank you for contributing to FinanceGPT! To help us address your issue efficiently, please follow these guidelines:
...
- `cloud` - For issues on FinanceGPT Cloud (hosted version)
...
- **Questions?** Use [GitHub Discussions](https://github.com/FinanceGPT/FinanceGPT/discussions)
- **Security Issues?** Please report privately to the maintainers
- **General Chat?** Join our community channels

Thank you for helping make FinanceGPT better! 🎉
