"""
Tools module for FinanceGPT deep agent.

This module contains all the tools available to the FinanceGPT agent.
To add a new tool, see the documentation in registry.py.

Available tools:
- search_knowledge_base: Search the user's personal knowledge base
- search_transactions: Search for specific transactions by merchant/keywords
