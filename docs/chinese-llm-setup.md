...
本指南将帮助你在 FinanceGPT 中配置和使用国产大语言模型。

This guide helps you configure and use Chinese LLM providers in FinanceGPT.

---

## 📋 支持的提供商 | Supported Providers

FinanceGPT 现已支持以下国产 LLM：
...
- 💬 [GitHub Issues](https://github.com/MODSetter/FinanceGPT/issues)
