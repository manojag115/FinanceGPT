---
title: "FinanceGPT v0.0.9 - Introducing the Agentic Architecture"
description: "FinanceGPT v0.0.9 introduces a new agentic architecture with intelligent source selection, temporal query understanding, and MCP compatibility."
date: "2025-12-24"
...
This release introduces the **FinanceGPT Agent**, a shift from pre-determined workflows (DAG) to dynamic, LLM-driven decision making.
...
FinanceGPT is an AI-powered federated search solution that connects all your knowledge sources in one place.

🎄 Merry Christmas from the FinanceGPT team!