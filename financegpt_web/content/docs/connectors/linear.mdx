---
title: Linear
description: Connect your Linear workspace to FinanceGPT
---

# Linear OAuth Integration Setup Guide

This guide walks you through setting up a Linear OAuth integration for FinanceGPT.
...
| **Application name** | `FinanceGPT` |
| **Developer name** | `FinanceGPT` |
| **Developer URL** | `https://www.financegpt.com/` |
...
## Running FinanceGPT with Linear Connector
