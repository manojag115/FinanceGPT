---
title: Confluence
description: Connect your Confluence spaces to FinanceGPT
---

# Confluence OAuth Integration Setup Guide

This guide walks you through setting up an Atlassian OAuth 2.0 (3LO) integration for FinanceGPT to connect your Confluence spaces.
...
## Running FinanceGPT with Confluence Connector
