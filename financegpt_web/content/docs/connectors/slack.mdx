---
title: Slack
description: Connect your Slack workspace to FinanceGPT
---

# Slack OAuth Integration Setup Guide

This guide walks you through setting up a Slack OAuth integration for FinanceGPT.
...
## Running FinanceGPT with Slack Connector
