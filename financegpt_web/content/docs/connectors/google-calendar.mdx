...
description: Connect your Google Calendar to FinanceGPT
---

# Google Calendar OAuth Integration Setup Guide

This guide walks you through setting up a Google OAuth 2.0 integration for FinanceGPT to connect your Google Calendar.
...
## Running FinanceGPT with Google Calendar Connector
