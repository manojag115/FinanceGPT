---
title: GitHub
description: Connect your GitHub repositories to FinanceGPT
---

# GitHub Connector

Connect your GitHub repositories to FinanceGPT for code search and AI-powered insights. The connector uses [gitingest](https://gitingest.com) to efficiently index entire codebases.
...
1. Go to [GitHub's token creation page](https://github.com/settings/tokens/new?description=financegpt&scopes=repo) (pre-filled with `repo` scope)
2. Set an expiration
