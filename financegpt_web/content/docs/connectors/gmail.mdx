---
title: Gmail
description: Connect your Gmail to FinanceGPT
---

# Gmail OAuth Integration Setup Guide

This guide walks you through setting up a Google OAuth 2.0 integration for FinanceGPT to connect your Gmail account.
...
## Running FinanceGPT with Gmail Connector
