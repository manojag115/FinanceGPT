		...
		<div className="container max-w-4xl mx-auto py-12 px-4">
			...
			<div className="prose dark:prose-invert max-w-none">
				...
				<section className="mb-8">
					...
					OTHER THAN AS EXPRESSLY SET OUT IN THESE TERMS OR ADDITIONAL TERMS, NEITHER FINANCEGPT
				...
				<section className="mb-8">
					...
					WHEN PERMITTED BY LAW, FINANCEGPT, AND FINANCEGPT'S SUPPLIERS AND DISTRIBUTORS, WILL NOT
					...
					<p className="mt-4 uppercase font-bold">
					TO THE EXTENT PERMITTED BY LAW, THE TOTAL LIABILITY OF FINANCEGPT, AND ITS SUPPLIERS AND
					...
					<p className="mt-4 uppercase font-bold">
					IN ALL CASES, FINANCEGPT, AND ITS SUPPLIERS AND DISTRIBUTORS, WILL NOT BE LIABLE FOR ANY
