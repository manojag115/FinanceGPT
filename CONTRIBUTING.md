# Contributing to FinanceGPT

Hey! 👋 Thanks for checking out **FinanceGPT**. We're stoked that you're interested in helping improve the project. Whether it's fixing bugs, suggesting features, improving docs, or just joining the conversation — every bit helps.

## 🧠 Before You Start

**Join Our Discord**  
Want to stay in the loop, ask questions, or get feedback before starting something?  
Hop into the official FinanceGPT community:  
...
🔗 [FinanceGPT GitHub Project Roadmap](https://github.com/users/MODSetter/projects/2)
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/MODSetter/FinanceGPT.git
   cd FinanceGPT
   ```

2. **Choose your setup method**:
   - **Docker Setup**: Follow the [Docker Setup Guide](./DOCKER_SETUP.md)
   - **Manual Setup**: Follow the [Installation Guide](https://www.financegpt.com/docs/)
...
For detailed setup instructions, refer to our [Installation Guide](https://www.financegpt.com/docs/).
...
2. **Search the docs** - [https://www.financegpt.com/docs/](https://www.financegpt.com/docs/)
...
- **Share FinanceGPT** with your community
- **Provide feedback** on Discord
- **Help triage issues** and validate bug reports
- **Improve documentation** and examples
- **Write tutorials** or blog posts about FinanceGPT
...
By contributing to FinanceGPT, you agree that your contributions will be licensed under the same license as the project.

---

**Thank you for contributing to FinanceGPT!** 🚀  
